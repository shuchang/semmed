...
output_paths = {
    'semmed': {
        ...
        'subgraph-cui-list-gd': './data/semmed/subgraph_cui_list_ground.txt',
        ...
        'sub-txt': './data/semmed/subgraph.txt',
        'txt-gd': './data/semmed/subgraph_ground.txt',
...
def main():
    ...
    routines = {
        'common': [
            ...
            # {'func': construct_graph, 'args': (input_paths['semmed']['csv'], output_paths['semmed']['cui-list'], output_paths['semmed']['graph'], output_paths['semmed']['txt'])},
        ],
        'hfdata': [
            ...
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['hfdata']['grounded']['train'], output_paths['semmed']['subgraph'],
                                                                        output_paths['semmed']['subgraph-cui-list'], output_paths['hfdata']['graph']['adj-train'], args.nprocs)},
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['hfdata']['grounded']['dev'], output_paths['semmed']['subgraph'],
                                                                        output_paths['semmed']['subgraph-cui-list'], output_paths['hfdata']['graph']['adj-dev'], args.nprocs)},
            {'func': generate_adj_data_from_grounded_concepts, 'args': (output_paths['hfdata']['grounded']['test'], output_paths['semmed']['subgraph'],
